...
class Block(nn.Module):
    def __init__(self, args: Hyperparameters):
        ...
        self.attn_scale = (
            nn.Parameter(torch.full((args.model_dim,), args.attn_scale_init, dtype=torch.float32))
            if args.use_attn_scale else None
        )
        self.mlp_scale = (
            nn.Parameter(torch.full((args.model_dim,), args.mlp_scale_init, dtype=torch.float32))
            if args.use_mlp_scale else None
        )
...
def main() -> None:
    ...
    log0(
        ...
        f" attn_scale_init={args.attn_scale_init}"
        f" mlp_scale_init={args.mlp_scale_init}"
