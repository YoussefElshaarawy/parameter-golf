...
SEED="${SEED:-42}"
RUN_ID="${RUN_ID:-FlyLikeButterfly_StingLikeBee_v2_seed${SEED}}"
...
STING_INTERVAL="${STING_INTERVAL:-5000}" \
STING_STEPS="${STING_STEPS:-32}" \
STING_SEQ_FRAC="${STING_SEQ_FRAC:-0.75}" \
STING_BATCH_FRAC="${STING_BATCH_FRAC:-0.5}" \
