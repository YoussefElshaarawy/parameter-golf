...
SEED="${SEED:-42}"
RUN_ID="${RUN_ID:-FlyLikeButterfly_StingLikeBee_seed${SEED}}"
...
STING_INTERVAL="${STING_INTERVAL:-700}" \
STING_STEPS="${STING_STEPS:-64}" \
STING_SEQ_FRAC="${STING_SEQ_FRAC:-1.0}" \
STING_BATCH_FRAC="${STING_BATCH_FRAC:-1.0}" \
