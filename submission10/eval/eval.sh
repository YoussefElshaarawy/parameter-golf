...
SEED="${SEED:-42}"
RUN_ID="${RUN_ID:-submission10_seed${SEED}}"
...
SPARSE_LONG_START_STEP="${SPARSE_LONG_START_STEP:-4000}" \
SPARSE_LONG_EVERY="${SPARSE_LONG_EVERY:-5}" \
SPARSE_LONG_SEQ_LEN="${SPARSE_LONG_SEQ_LEN:-3072}" \
