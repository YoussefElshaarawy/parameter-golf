...
class Hyperparameters:
    ...
    full_train_frac = float(os.environ.get("FULL_TRAIN_FRAC", "0.2"))
    ...
    eval_seq_len = int(os.environ.get("EVAL_SEQ_LEN", max(base_train_seq_len, train_seq_len)))
    ...
    full_train_steps = int(os.environ.get("FULL_TRAIN_STEPS", max(0, min(iterations, int(iterations * full_train_frac)))))
...
def main() -> None:
    ...
    log0(
        ...
        f"full_train_steps:{args.full_train_steps} full_seq_len:{args.base_train_seq_len} "
    ...
    if master_process:
        ...
        log0(
            "preflight_summary: "
            f"full_train_frac={args.full_train_frac} "
            f"full_train_steps={args.full_train_steps} "
    ...
    def train_schedule(step_idx: int) -> tuple[int, int, str]:
        if step_idx < args.full_train_steps:
            return args.base_train_batch_tokens, args.base_train_seq_len, "full"
